...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato1), \" (\", ROUND(((((sum(a.candidato1)/(sum(validos)))))*100),1), \"%)\")   from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato2), \" (\", ROUND((((sum(a.candidato2)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato3), \" (\", ROUND((((sum(a.candidato3)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato4), \" (\", ROUND((((sum(a.candidato4)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato5), \" (\", ROUND((((sum(a.candidato5)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato6), \" (\", ROUND((((sum(a.candidato6)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato7), \" (\", ROUND((((sum(a.candidato7)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato8), \" (\", ROUND((((sum(a.candidato8)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato9), \" (\", ROUND((((sum(a.candidato9)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato10), \" (\", ROUND((((sum(a.candidato10)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato11), \" (\", ROUND((((sum(a.candidato11)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(sum(a.candidato12), \" (\", ROUND((((sum(a.candidato12)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
//	Custom field settings
	...
	// end of report field settings
		...
		$fdata["isSQLExpression"] = true;
	$fdata["FullName"] = "(select concat(((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) + (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8))   + (sum(a.candidato9)) + (sum(a.candidato12))), \" (\", ROUND((((((sum(a.candidato1)) + (sum(a.candidato2)) + (sum(a.candidato3)) + (sum(a.candidato4)) +  (sum(a.candidato6)) + (sum(a.candidato7)) + (sum(a.candidato8)) + (sum(a.candidato9)) + (sum(a.candidato12))) / (sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto11["m_strFieldList"] = "concat(sum(a.candidato1), \" (\", ROUND(((((sum(a.candidato1)/(sum(validos)))))*100),1), \"%)\")";
...
$proto17["m_sql"] = "concat(sum(a.candidato1), \" (\", ROUND(((((sum(a.candidato1)/(sum(validos)))))*100),1), \"%)\")";
...
$proto10["m_sql"] = "(select concat(sum(a.candidato1), \" (\", ROUND(((((sum(a.candidato1)/(sum(validos)))))*100),1), \"%)\")   from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto32["m_strFieldList"] = "concat(sum(a.candidato2), \" (\", ROUND((((sum(a.candidato2)/(sum(validos))))*100),1), \"%)\")";
...
$proto38["m_sql"] = "concat(sum(a.candidato2), \" (\", ROUND((((sum(a.candidato2)/(sum(validos))))*100),1), \"%)\")";
...
$proto31["m_sql"] = "(select concat(sum(a.candidato2), \" (\", ROUND((((sum(a.candidato2)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto53["m_strFieldList"] = "concat(sum(a.candidato3), \" (\", ROUND((((sum(a.candidato3)/(sum(validos))))*100),1), \"%)\")";
...
$proto59["m_sql"] = "concat(sum(a.candidato3), \" (\", ROUND((((sum(a.candidato3)/(sum(validos))))*100),1), \"%)\")";
...
$proto52["m_sql"] = "(select concat(sum(a.candidato3), \" (\", ROUND((((sum(a.candidato3)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto74["m_strFieldList"] = "concat(sum(a.candidato4), \" (\", ROUND((((sum(a.candidato4)/(sum(validos))))*100),1), \"%)\")";
...
$proto80["m_sql"] = "concat(sum(a.candidato4), \" (\", ROUND((((sum(a.candidato4)/(sum(validos))))*100),1), \"%)\")";
...
$proto73["m_sql"] = "(select concat(sum(a.candidato4), \" (\", ROUND((((sum(a.candidato4)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto95["m_strFieldList"] = "concat(sum(a.candidato5), \" (\", ROUND((((sum(a.candidato5)/(sum(validos))))*100),1), \"%)\")";
...
$proto101["m_sql"] = "concat(sum(a.candidato5), \" (\", ROUND((((sum(a.candidato5)/(sum(validos))))*100),1), \"%)\")";
...
$proto94["m_sql"] = "(select concat(sum(a.candidato5), \" (\", ROUND((((sum(a.candidato5)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto116["m_strFieldList"] = "concat(sum(a.candidato6), \" (\", ROUND((((sum(a.candidato6)/(sum(validos))))*100),1), \"%)\")";
...
$proto122["m_sql"] = "concat(sum(a.candidato6), \" (\", ROUND((((sum(a.candidato6)/(sum(validos))))*100),1), \"%)\")";
...
$proto115["m_sql"] = "(select concat(sum(a.candidato6), \" (\", ROUND((((sum(a.candidato6)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto137["m_strFieldList"] = "concat(sum(a.candidato7), \" (\", ROUND((((sum(a.candidato7)/(sum(validos))))*100),1), \"%)\")";
...
$proto143["m_sql"] = "concat(sum(a.candidato7), \" (\", ROUND((((sum(a.candidato7)/(sum(validos))))*100),1), \"%)\")";
...
$proto136["m_sql"] = "(select concat(sum(a.candidato7), \" (\", ROUND((((sum(a.candidato7)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto158["m_strFieldList"] = "concat(sum(a.candidato8), \" (\", ROUND((((sum(a.candidato8)/(sum(validos))))*100),1), \"%)\")";
...
$proto164["m_sql"] = "concat(sum(a.candidato8), \" (\", ROUND((((sum(a.candidato8)/(sum(validos))))*100),1), \"%)\")";
...
$proto157["m_sql"] = "(select concat(sum(a.candidato8), \" (\", ROUND((((sum(a.candidato8)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto179["m_strFieldList"] = "concat(sum(a.candidato9), \" (\", ROUND((((sum(a.candidato9)/(sum(validos))))*100),1), \"%)\")";
...
$proto185["m_sql"] = "concat(sum(a.candidato9), \" (\", ROUND((((sum(a.candidato9)/(sum(validos))))*100),1), \"%)\")";
...
$proto178["m_sql"] = "(select concat(sum(a.candidato9), \" (\", ROUND((((sum(a.candidato9)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto200["m_strFieldList"] = "concat(sum(a.candidato10), \" (\", ROUND((((sum(a.candidato10)/(sum(validos))))*100),1), \"%)\")";
...
$proto206["m_sql"] = "concat(sum(a.candidato10), \" (\", ROUND((((sum(a.candidato10)/(sum(validos))))*100),1), \"%)\")";
...
$proto199["m_sql"] = "(select concat(sum(a.candidato10), \" (\", ROUND((((sum(a.candidato10)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto221["m_strFieldList"] = "concat(sum(a.candidato11), \" (\", ROUND((((sum(a.candidato11)/(sum(validos))))*100),1), \"%)\")";
...
$proto227["m_sql"] = "concat(sum(a.candidato11), \" (\", ROUND((((sum(a.candidato11)/(sum(validos))))*100),1), \"%)\")";
...
$proto220["m_sql"] = "(select concat(sum(a.candidato11), \" (\", ROUND((((sum(a.candidato11)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
...
$proto242["m_strFieldList"] = "concat(sum(a.candidato12), \" (\", ROUND((((sum(a.candidato12)/(sum(validos))))*100),1), \"%)\")";
...
$proto248["m_sql"] = "concat(sum(a.candidato12), \" (\", ROUND((((sum(a.candidato12)/(sum(validos))))*100),1), \"%)\")";
...
$proto241["m_sql"] = "(select concat(sum(a.candidato12), \" (\", ROUND((((sum(a.candidato12)/(sum(validos))))*100),1), \"%)\")  from voto_alcalde as a  inner join urna as u on a.id_urna = u.id_urna where u.id_sector = ur.id_sector)";
