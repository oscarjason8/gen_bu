...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "actas", "varname" => "internas_new_at_localhost__actas", "altvarname" => "actas", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "candidatos", "varname" => "internas_new_at_localhost__candidatos", "altvarname" => "candidatos", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "corporacion", "varname" => "internas_new_at_localhost__corporacion", "altvarname" => "corporacion", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "corporaciones", "varname" => "internas_new_at_localhost__corporaciones", "altvarname" => "corporaciones", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "distritos", "varname" => "internas_new_at_localhost__distritos", "altvarname" => "distritos", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "estructura", "varname" => "internas_new_at_localhost__estructura", "altvarname" => "estructura", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "generales_uggroups", "varname" => "internas_new_at_localhost__generales_uggroups", "altvarname" => "generales_uggroups", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "generales_ugmembers", "varname" => "internas_new_at_localhost__generales_ugmembers", "altvarname" => "generales_ugmembers", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "generales_ugrights", "varname" => "internas_new_at_localhost__generales_ugrights", "altvarname" => "generales_ugrights", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "partido", "varname" => "internas_new_at_localhost__partido", "altvarname" => "partido", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "sectores", "varname" => "internas_new_at_localhost__sectores", "altvarname" => "sectores", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "urna", "varname" => "internas_new_at_localhost__urna", "altvarname" => "urna", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "usuario", "varname" => "internas_new_at_localhost__usuario", "altvarname" => "usuario", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "vdiputados", "varname" => "internas_new_at_localhost__vdiputados", "altvarname" => "vdiputados", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "voto_alcalde", "varname" => "internas_new_at_localhost__voto_alcalde", "altvarname" => "voto_alcalde", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "voto_diputado", "varname" => "internas_new_at_localhost__voto_diputado", "altvarname" => "voto_diputado", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
			$dalTables[$conn->connId][] = array("name" => "voto_presidente", "varname" => "internas_new_at_localhost__voto_presidente", "altvarname" => "voto_presidente", "connId" => "internas_new_at_localhost", "schema" => "", "connName" => "ampc_gen at ampuertocortes.hn");
		}
	}
